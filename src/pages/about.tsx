    ...
    <section id="about">
      ...
      <div className="row">
        <div className="col-12 p-sm-1 pb-2">
          <div className={`card ${theme.bgClass} ${theme.textClass}`}>
            <div className="card-body">
              <h3 className="card-title h5">Trayectoria</h3>
              <p className="card-text m-0">
                Mi travesía en el mundo de la tecnología comienza en 2014,
                cuando comencé a crear aplicaciones para Windows Phone y
                Windows. Para lograr esto aprendí Visual Basic, y posteriormente
                C# y XAML. Realicé algunos proyectos que me ayudaron a entender
                muchas de las bases de la programación.
              </p>
              <p className="card-text m-0 mt-2">
                Fue en la Universidad donde comencé a aprender y trabajar con
                tecnologías web, donde aprendí HTML, Python y JavaScript.
                Tambien durante este tiempo aprendí por mi cuenta Angular, React
                y Firebase, y descubrí que lo mio es el desarrollo front-end.
              </p>
              <p className="card-text m-0 mt-2">
