        ...
        <div className="card bg-dark text-light">
          <div className="card-body">
            ...
            <p className="card-text m-0">
              Mi travesía en el mundo de la tecnología comienza en 2014, cuando comencé a crear aplicaciones para Windows Phone y Windows. Para lograr esto aprendí Visual Basic, y posteriormente C# y XAML.
            </p>
